    ...
    Do you follow it, or continue on your path?`)
        if (secondAnswer === 'follow'){
            ...
            if (thirdAnswer === 'stay'){
                ...
                else if (thirdAnswer === 'Spread the word.'){console.log('After leaving the cat colony, you are never able to find it again; without proof, no one believes your story, which passes into legend nonetheless..')}
            }
